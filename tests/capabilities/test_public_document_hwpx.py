...
SPEC = importlib.util.spec_from_file_location("test_public_document_hwpx_adapter", REPO_ROOT / "kgov_runtime" / "capabilities" / "public_document_hwpx.py")
...
class AdapterTest(unittest.TestCase):
    def test_fixture_is_deterministic(self) -> None:
        fixture = json.loads((REPO_ROOT / "tests" / "fixtures" / "capabilities" / "public-document-hwpx.json").read_text(encoding="utf-8"))
