...
SPEC = importlib.util.spec_from_file_location(
    ...
    REPO_ROOT / "kgov_runtime" / "capabilities" / "official_source_research.py",
)
...
class AdapterTest(unittest.TestCase):
    def test_fixture_is_deterministic(self) -> None:
        fixture = json.loads((REPO_ROOT / "tests" / "fixtures" / "capabilities" / "official-source-research.json").read_text(encoding="utf-8"))
