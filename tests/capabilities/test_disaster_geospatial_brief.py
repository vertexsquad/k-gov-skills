...
SPEC = importlib.util.spec_from_file_location("test_disaster_geospatial_brief_adapter", REPO_ROOT / "kgov_runtime" / "capabilities" / "disaster_geospatial_brief.py")
...
class AdapterTest(unittest.TestCase):
    def test_fixture_mode_is_deterministic(self) -> None:
        payload = json.loads((REPO_ROOT / "tests" / "fixtures" / "capabilities" / "disaster-geospatial-brief.json").read_text(encoding="utf-8"))
