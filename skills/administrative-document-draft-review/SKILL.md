---
name: administrative-document-draft-review
description: 비식별 공문·보고서·회의자료·보도자료를 근거와 불확실성이 드러나는 담당자 검토용 초안으로 작성·검토합니다.
---
...
```bash
python3 skills/administrative-document-draft-review/scripts/adapter.py --fixture
python3 skills/administrative-document-draft-review/scripts/adapter.py redacted-document.json
```
