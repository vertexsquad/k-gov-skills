...
- fixture 검증: `python3 skills/civil-complaint-triage-draft/scripts/adapter.py --fixture`
- 로컬 입력 검사: `python3 skills/civil-complaint-triage-draft/scripts/adapter.py <redacted-input.json>`
