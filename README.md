...
catalog/domain-skills.json                     # 60 domain·132 Skill·21 capability SSOT
...
모든 `name`은 저장소 전체에서 고유합니다. 60개 domain에 primary 60개와 additional 72개,
총 132개 domain-owned Skill 진입점이 있습니다.
