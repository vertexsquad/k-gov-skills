...
RUNTIME_CONTRACT_ID: Final[str] = "kgov/public-it-project-procedure-review/v1"
RUNTIME_OPERATION_IDS: Final[tuple[str, ...]] = ("kgov/public-it-project-procedure-review/review-case/v1",)
