...
RUNTIME_CONTRACT_ID: Final[str] = "kgov/public-procurement-research/v1"
RUNTIME_OPERATION_IDS: Final[tuple[str, ...]] = ("kgov/public-procurement-research/query-order-plans/v1",)
