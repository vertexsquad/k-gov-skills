...
RUNTIME_CONTRACT_ID: Final[str] = "kgov/building-permit-document-precheck/v1"
RUNTIME_OPERATION_IDS: Final[tuple[str, ...]] = ("kgov/building-permit-document-precheck/review-case/v1",)
