#!/usr/bin/env python3
"""복지·보건 공공데이터 API read-only adapter."""
...
CONFIG = JsonAdapterConfig(
    slug="welfare-health-safety-research",
    default_endpoint="https://apis.data.go.kr/",
    allowed_hosts=frozenset(['apis.data.go.kr', 'e-gen.or.kr', 'nhis.or.kr', 'mfds.go.kr']),
    credential_env="DATA_GO_KR_API_KEY",
    credential_param="serviceKey",
    default_params={'type': 'json'},
)
FIXTURE = ROOT / "tests" / "fixtures" / "capabilities" / "welfare-health-safety-research.json"
