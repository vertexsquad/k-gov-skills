...
RUNTIME_CONTRACT_ID: Final[str] = "kgov/construction-standard-bim-compliance-precheck/v1"
RUNTIME_OPERATION_IDS: Final[tuple[str, ...]] = ("kgov/construction-standard-bim-compliance-precheck/review-case/v1",)
