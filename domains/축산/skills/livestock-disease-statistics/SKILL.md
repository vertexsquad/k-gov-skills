---
name: livestock-disease-statistics
description: "축산 업무의 가축질병·축산통계 조회 절차. 내부 kosis-official-statistics capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  domain: "축산"
...
- 실행 경계: `read-only`
- Reference Skill: `kosis-stats`, `korea-weather`
