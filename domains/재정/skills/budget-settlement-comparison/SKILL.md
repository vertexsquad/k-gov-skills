---
name: budget-settlement-comparison
description: "재정 업무의 예산·결산 비교 절차. 내부 kosis-official-statistics capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  domain: "재정"
...
- 실행 경계: `read-only`
- Reference Skill: `kosis-stats`, `k-dart`
