---
name: fiscal-budget-execution-evidence-pack
description: "재정 업무의 재정 집행 근거 팩 절차. 내부 public-policy-evidence-pack capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "재정"
