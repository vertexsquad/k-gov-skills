---
name: fisheries-weather-statistics
description: "해양수산 업무의 해양기상·수산통계 조회 절차. 내부 kosis-official-statistics capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  domain: "해양수산"
...
- 실행 경계: `read-only`
- Reference Skill: `kosis-stats`, `korea-weather`, `han-river-water-level`
