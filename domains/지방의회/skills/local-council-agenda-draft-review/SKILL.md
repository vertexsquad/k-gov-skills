---
name: local-council-agenda-draft-review
description: "지방의회 업무의 지방의회 의안·상정안 초안 검토 절차. 내부 administrative-document-draft-review capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "지방의회"
...
- 의안 요지·제안이유·주요내용·검토사항 분리
- 기존 회의록·조례 조사 Skill과 역할 분리
- 상정·의결·공개는 의회 담당자 승인
