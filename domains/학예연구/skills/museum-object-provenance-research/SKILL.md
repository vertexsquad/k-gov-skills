---
name: museum-object-provenance-research
description: "학예연구 업무의 유물·자료 출처 조사 절차. 내부 official-source-research capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "학예연구"
...
- 실행 경계: `draft-only`
- Reference Skill: `joseon-sillok-search`, `library-book-search`
