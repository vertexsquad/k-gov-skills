---
name: performance-arts-search
description: "문화예술 업무의 공연예술·시설 조회 절차. 내부 official-source-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  domain: "문화예술"
...
- 실행 경계: `read-only`
- Reference Skill: `kopis-performance-search`
