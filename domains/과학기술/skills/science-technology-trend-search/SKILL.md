---
name: science-technology-trend-search
description: "과학기술 업무의 과학기술 특허·동향 조사 절차. 내부 official-source-research capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "과학기술"
...
- 실행 경계: `draft-only`
- Reference Skill: `korean-patent-search`, `kosis-stats`
