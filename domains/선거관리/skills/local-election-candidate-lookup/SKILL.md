---
name: local-election-candidate-lookup
description: "선거관리 업무의 지방선거 후보자 조회 절차. 내부 official-source-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  domain: "선거관리"
...
- 실행 경계: `read-only`
- Reference Skill: `local-election-candidate-search`
