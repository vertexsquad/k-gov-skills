---
name: election-law-citation-verification
description: "선거관리 업무의 선거법령 인용 검증 절차. 내부 korean-legal-citation-verification capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "선거관리"
...
- 선거유형·선거구·행위주체·행위·기준일별 적용 법령 후보를 분리
- 국가법령정보센터의 조문·시행일·공식 URL·조회일을 보존하고 유권자·후보자 개인정보 원문을 포함하지 않음
