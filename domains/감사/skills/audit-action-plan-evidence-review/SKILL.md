---
name: audit-action-plan-evidence-review
description: "감사 업무의 감사 조치계획 근거 검토 절차. 내부 administrative-document-draft-review capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "감사"
