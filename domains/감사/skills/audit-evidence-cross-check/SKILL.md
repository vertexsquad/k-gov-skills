---
name: audit-evidence-cross-check
description: "감사 업무의 감사 증빙 교차검증 절차. 내부 official-source-research capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "감사"
...
- 실행 경계: `draft-only`
- Reference Skill: `biz-health-check`, `g2b-sanctioned-supplier`
