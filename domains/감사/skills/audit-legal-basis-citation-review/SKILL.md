---
name: audit-legal-basis-citation-review
description: "감사 업무의 감사 법적근거 인용 검토 절차. 내부 korean-legal-citation-verification capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "감사"
...
- 감사유형·대상기관·지적사항·처분 후보별 적용 법령과 기준시점을 분리
