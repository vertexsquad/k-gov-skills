---
name: official-research-brief
description: "연구 업무의 공식출처 연구 브리프 절차. 내부 official-source-research capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "연구"
...
- 실행 경계: `draft-only`
- Reference Skill: `kosis-stats`, `k-dart`, `naver-news-search`, `daishin-report-search`
