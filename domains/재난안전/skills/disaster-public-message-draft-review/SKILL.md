---
name: disaster-public-message-draft-review
description: "재난안전 업무의 재난 공공안내문 초안 검토 절차. 내부 disaster-geospatial-brief capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "재난안전"
...
- 발령 시각·대상 지역·기관·행동요령을 명시
- 조회 자료 시각과 안내문 기준 시각을 비교
- 실제 발송 직전 담당기관이 최신성을 승인
