---
name: disaster-situation-brief
description: "재난안전 업무의 기상·수위·대기 재난브리프 절차. 내부 disaster-geospatial-brief capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "재난안전"
...
- 실행 경계: `draft-only`
- Reference Skill: `korea-weather`, `fine-dust-location`, `han-river-water-level`, `emergency-room-beds`
