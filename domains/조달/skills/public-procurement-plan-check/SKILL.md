---
name: public-procurement-plan-check
description: "조달 업무의 나라장터 발주·제재 조회 절차. 내부 public-procurement-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "조달"
...
- 실행 경계: `read-only`
- Reference Skill: `g2b-order-plan-search`, `g2b-sanctioned-supplier`
