---
name: environment-air-water-waste
description: "환경 업무의 대기·수위·폐기물 정보 조회 절차. 내부 disaster-geospatial-brief capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "환경"
...
- 실행 경계: `read-only`
- Reference Skill: `fine-dust-location`, `han-river-water-level`, `household-waste-info`, `korea-weather`
