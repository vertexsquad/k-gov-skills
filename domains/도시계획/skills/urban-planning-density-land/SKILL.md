---
name: urban-planning-density-land
description: "도시계획 업무의 혼잡도·토지·주택 조사 절차. 내부 land-housing-geospatial-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "도시계획"
...
- 실행 경계: `read-only`
- Reference Skill: `seoul-density`, `gongsijiga-search`, `lh-notice-search`, `sh-notice-search`
