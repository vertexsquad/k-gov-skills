---
name: local-government-business-status
description: "지방자치 업무의 지방행정 인허가·생활정보 조회 절차. 내부 official-source-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  domain: "지방자치"
...
- 실행 경계: `read-only`
- Reference Skill: `localdata-business-status`, `local-election-candidate-search`, `kakao-map`
