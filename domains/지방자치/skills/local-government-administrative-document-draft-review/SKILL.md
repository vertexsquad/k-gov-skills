---
name: local-government-administrative-document-draft-review
description: "지방자치 업무의 행정문서 초안·검토 절차. 내부 administrative-document-draft-review capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "지방자치"
