---
name: local-government-civil-complaint-triage-draft
description: "지방자치 업무의 민원 분류·답변 초안 절차. 내부 civil-complaint-triage-draft capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  domain: "지방자치"
