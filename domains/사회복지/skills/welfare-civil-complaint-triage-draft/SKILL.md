---
name: welfare-civil-complaint-triage-draft
description: "사회복지 업무의 복지 민원 분류·답변 초안 절차. 내부 civil-complaint-triage-draft capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "사회복지"
...
- 급여·서비스·기관 문의를 분리
- 수급자격·금액·대상자 여부를 자동 판정하지 않음
- 안내 발송과 자격 판단은 담당기관 승인
