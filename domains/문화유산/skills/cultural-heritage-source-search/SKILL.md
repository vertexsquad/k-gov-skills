---
name: cultural-heritage-source-search
description: "문화유산 업무의 문화유산 공식자료 검색 절차. 내부 official-source-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "문화유산"
...
- 실행 경계: `read-only`
- Reference Skill: `joseon-sillok-search`
