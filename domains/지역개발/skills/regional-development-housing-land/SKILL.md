---
name: regional-development-housing-land
description: "지역개발 업무의 주택·토지·혼잡도 개발정보 조회 절차. 내부 land-housing-geospatial-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  domain: "지역개발"
...
- 실행 경계: `read-only`
- Reference Skill: `lh-notice-search`, `sh-notice-search`, `gongsijiga-search`, `seoul-density`
