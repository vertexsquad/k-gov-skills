---
name: public-tourism-information
description: "관광 업무의 공공 관광정보 조사 절차. 내부 official-source-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "관광"
...
- 실행 경계: `read-only`
- Reference Skill: `foresttrip-vacancy`, `kakao-map`, `myrealtrip-search`
