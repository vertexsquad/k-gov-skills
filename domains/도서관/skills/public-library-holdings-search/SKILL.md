---
name: public-library-holdings-search
description: "도서관 업무의 공공도서관 소장자료 조회 절차. 내부 official-source-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  domain: "도서관"
...
- 실행 경계: `read-only`
- Reference Skill: `library-book-search`
