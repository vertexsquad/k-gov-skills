---
name: civil-facility-project-review
description: "토목시설 업무의 공사·시설점검 자료 조사 절차. 내부 land-housing-geospatial-research capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "토목시설"
...
- 실행 경계: `draft-only`
- Reference Skill: `kakao-map`, `gongsijiga-search`
