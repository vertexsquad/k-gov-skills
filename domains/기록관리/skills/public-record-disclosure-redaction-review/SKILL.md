---
name: public-record-disclosure-redaction-review
description: "기록관리 업무의 공공기록 공개·마스킹 검토 절차. 내부 public-record-disclosure-redaction-review capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  domain: "기록관리"
...
- 공개·비공개·부분공개 후보를 근거별 분리
- 직접식별자 no-match를 완전 마스킹 증명으로 사용하지 않음
- 공개 결정과 원문 변경은 정보공개 담당자 승인
