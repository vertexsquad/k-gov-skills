---
name: privacy-security-baseline-review
description: "사이버보안 업무의 개인정보·보안기준 검토 절차. 내부 official-source-research capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "사이버보안"
...
- 실행 경계: `draft-only`
- Reference Skill: `korean-privacy-terms`
