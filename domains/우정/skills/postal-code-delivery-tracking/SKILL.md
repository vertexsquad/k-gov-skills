---
name: postal-code-delivery-tracking
description: "우정 업무의 우편번호·배송조회 절차. 내부 official-source-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "우정"
...
- 실행 경계: `read-only`
- Reference Skill: `delivery-tracking`, `zipcode-search`
