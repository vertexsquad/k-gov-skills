---
name: education-public-data-search
description: "교육 업무의 교육 공공데이터·장학 조회 절차. 내부 official-source-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  domain: "교육"
...
- 실행 경계: `read-only`
- Reference Skill: `k-schoollunch-menu`, `korean-scholarship-search`
