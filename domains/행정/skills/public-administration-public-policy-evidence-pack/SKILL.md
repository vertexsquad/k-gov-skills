---
name: public-administration-public-policy-evidence-pack
description: "행정 업무의 정책 근거 묶음 절차. 내부 public-policy-evidence-pack capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "행정"
