---
name: fuel-energy-statistics
description: "에너지 업무의 유가·에너지통계 조회 절차. 내부 kosis-official-statistics capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  domain: "에너지"
...
- 실행 경계: `read-only`
- Reference Skill: `cheap-gas-nearby`, `kosis-stats`
