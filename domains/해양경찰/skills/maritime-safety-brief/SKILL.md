---
name: maritime-safety-brief
description: "해양경찰 업무의 해양기상·안전상황 브리프 절차. 내부 disaster-geospatial-brief capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  domain: "해양경찰"
...
- 실행 경계: `draft-only`
- Reference Skill: `korea-weather`, `han-river-water-level`
