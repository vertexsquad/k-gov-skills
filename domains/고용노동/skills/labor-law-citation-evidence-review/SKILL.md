---
name: labor-law-citation-evidence-review
description: "고용노동 업무의 노동법 인용 근거 검토 절차. 내부 korean-legal-citation-verification capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  domain: "고용노동"
...
- 법령·조문·시행일·사건 또는 행정해석 후보·기준시점을 분리
