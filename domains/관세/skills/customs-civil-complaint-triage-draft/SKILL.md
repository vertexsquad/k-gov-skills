---
name: customs-civil-complaint-triage-draft
description: "관세 업무의 관세 민원 분류·답변 초안 절차. 내부 civil-complaint-triage-draft capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "관세"
...
- 민원유형·수출입단계·품목·요청사항·처리기한을 비식별 상태로 분리
