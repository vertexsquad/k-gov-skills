---
name: land-building-housing-research
description: "건축 업무의 토지·등기·공공주택 조사 절차. 내부 land-housing-geospatial-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  domain: "건축"
...
- 실행 경계: `read-only`
- Reference Skill: `gongsijiga-search`, `iros-registry-automation`, `lh-notice-search`, `sh-notice-search`
