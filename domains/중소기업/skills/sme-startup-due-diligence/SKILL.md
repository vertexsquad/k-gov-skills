---
name: sme-startup-due-diligence
description: "중소기업 업무의 창업지원·사업자 실사 절차. 내부 official-source-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "중소기업"
...
- 실행 경계: `read-only`
- Reference Skill: `kstartup-search`, `biz-health-check`, `nts-business-registration`
