---
name: ict-policy-evidence-brief
description: "정보통신 업무의 정보통신 정책·민원 브리프 절차. 내부 public-policy-evidence-pack capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  domain: "정보통신"
...
- 정보통신 정책 주장·대상·기준일·지표를 분리
- 공식 자료 URL·발행기관·조회일·문서 버전을 보존
- 정보통신 정책 결정·지원·집행·개별 판단은 담당자 승인으로 이관
