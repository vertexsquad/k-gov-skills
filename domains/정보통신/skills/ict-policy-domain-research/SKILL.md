---
name: ict-policy-domain-research
description: "정보통신 업무의 WHOIS·정보통신 정책 조사 절차. 내부 official-source-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  domain: "정보통신"
...
- 실행 경계: `read-only`
- Reference Skill: `kr-whois-lookup`, `korean-privacy-terms`
