---
name: police-lost-property-lookup
description: "경찰 업무의 LOST112 유실물 조회 절차. 내부 official-source-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "경찰"
...
- 실행 경계: `read-only`
- Reference Skill: `subway-lost-property`
