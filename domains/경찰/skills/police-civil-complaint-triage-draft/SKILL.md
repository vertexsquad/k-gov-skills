---
name: police-civil-complaint-triage-draft
description: "경찰 업무의 경찰 민원 분류·답변 초안 절차. 내부 civil-complaint-triage-draft capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "경찰"
...
- 치안 민원 소관과 긴급성 후보를 분리
- 수사·처분·출동 여부를 자동 결정하지 않음
- 긴급 신고는 공식 112 경로로 즉시 이관
