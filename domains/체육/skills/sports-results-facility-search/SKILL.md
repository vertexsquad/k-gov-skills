---
name: sports-results-facility-search
description: "체육 업무의 경기결과·체육정보 조회 절차. 내부 official-source-research capability를 사용하며 read-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "체육"
...
- 실행 경계: `read-only`
- Reference Skill: `kbo-results`, `kbl-results`, `kleague-results`, `korean-marathon-schedule`
