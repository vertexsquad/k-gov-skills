---
name: education-administrative-document-draft-review
description: "교육행정 업무의 교육행정 문서 초안 검토 절차. 내부 administrative-document-draft-review capability를 사용하며 draft-only 경계를 지킵니다."
metadata:
  kgov:
    domain: "교육행정"
...
- 공문·가정통신문·회의자료 문서유형을 명시
- 학생·보호자·교직원 개인정보 원문 입력 금지
- 결재·배포·발송은 교육행정 담당자 승인
